...
description: "Install and configure PADS4 Viewer on BrightSign Series-6 players (HD6, XD6) running BrightSign OS 9.1.92.2 or later with a microSD card."
---

This guide provides step-by-step instructions for installing and configuring **PADS4 Viewer** on **BrightSign Series-6** players.

## **Before You Start**

### **Supported BrightSign Series-6 Players**

The following **Series-6 BrightSign players** are supported:
...
Your BrightSign player must be running **BrightSign OS 9.1.92.2 or later**.

...
description: "Install and configure PADS4 Viewer on BrightSign Series-4 players (LS4, HD4, XD4, XT4) using BrightSign OS 8.5.47 and a microSD card."
---
...
<Warning>
  ****_Note: HDMI-in on the XT1144 is not supported._****
</Warning>
...
- We recommend using industrial-class microSD cards to ensure long endurance.

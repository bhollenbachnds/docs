...
description: "Install and configure PADS4 Viewer on BrightSign Series-5 players (LS5, HD5, XD5, XT5, HS5) running BrightSign OS 9.0.120 or later."
---

This guide provides step-by-step instructions for installing and configuring **PADS4 Viewer** on **BrightSign Series 5** players.

## **Before You Start**

### **Supported BrightSign Series-5 Players**

The following **Series-5 BrightSign players** are supported:
...
<Warning>
  **_Note: The following features are not supported:_**

  - **HDMI-in** on **XT1145 & XT2145**
  - **Dual HDMI-out** on **XT2145**
</Warning>
...
Before installation, ensure that your **PADS4 Server** is running **PADS4 version 2023.2** or higher.

<Note>
  It is recommended to **complete the installation of the PADS4 Server first** before configuring your BrightSign player.
</Note>

### **BrightSign OS Version**

Your BrightSign player must be running **BrightSign OS 9.0.120 or later**.
...
<Steps>
  ...
  <Step title="Step Two">
    ...
    <Note>
      Ensure the microSD card is **empty** before proceeding.
    </Note>
  </Step>
  <Step title="Step Three">
...
| ✅ | **Supports BrightSign OS 9.0.120\+** – Required for compatibility. |

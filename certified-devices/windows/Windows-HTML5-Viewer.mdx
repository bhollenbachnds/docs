...
description: Install and configure the PADS4 Windows HTML5 Viewer on Windows 10 build 1909 or newer PCs, with sync repeat support and Kiosk mode user switching.
---
...
<Warning>
  PADS4 Windows HTML viewer version 1.4.0 \+ PADS4 version 2025.2 is required to have the "Switch User" option in the Launcher settings. Which enables easy user account switching when using Windows Kiosk mode.
</Warning>
...
> Note: This viewer shares the same limitations as other HTML viewers. Refer to the [HTML5 Viewer Known Limitations](https://support.pads4.com/en/support/solutions/articles/204000036395-known-limitations-for-html5-viewer) for more information.
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/installer.png"
/>

<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/installer-progress.png"
/>
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/installation-succesful.png"
/>
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/server-config.png"
/>
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/viewer-started.png"
/>
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/viewer-settings.png"
/>
...
You can exit Kiosk Mode and switch to a standard Windows account in three ways:

- <u>Since PADS4 version </u>\*\*<u>2025.2</u> \*\*you can switch users with the "**Switch User**" option by entering the \*\*Viewer settings \*\*-\> **Launcher settings** -\> bottom right "**Switch User**"
- Use **Remote Desktop** (if configured) to log in directly using a different user account.
- Reboot the machine while holding the **Shift** key. This brings up the Windows login screen.
...
<img
  height="200"
  src="/images/install-pads4/install-pads4-viewer/intall-pads4-html5-windows-viewer/screensaver.png"
/>

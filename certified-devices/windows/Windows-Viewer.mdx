...
description: Install the PADS4 Clients bundle on Windows PCs to deploy the PADS4 Viewer, Designer, Scheduler, and related Windows-based signage applications.
---
...
Download the latest version of **PADS4 Clients** from the official link:<br />[**PADS4 Clients Download**](http://go.pads4.com/?fwlink=1011)
...
- Once completed, you will see the message:<br />**"PADS4 Clients has been successfully installed."**

---

## **Network Ports Used by PADS4**

To ensure proper connectivity, review the **network ports required** for PADS4.<br />➡ Refer to the [**Network Ports Configuration**](#) page for more details.
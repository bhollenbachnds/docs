...
The PADS4 scheduling engine. Manages dayparts, playlists assignments to time slots, scheduling exceptions, and the calendar of what content plays on which displays at what times.

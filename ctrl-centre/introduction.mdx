...
- When you have permissions for more than one of the above apps, they will be shown after the credentials are specified.
...
- After you enter your credentials during Log In, a list with apps will be shown for which you have permissions. If this is not the case, ask your System Administrator for permissions.

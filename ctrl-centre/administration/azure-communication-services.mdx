...
description: "Create an Azure Communication Services resource and copy the primary connection string that PADS4 CTRL Centre needs for the Microsoft Teams integration."
---

...
description: "Connect Active Directory to PADS4 CTRL Centre through the Credentials interface using LDAP or LDAPS to import users for authentication and management."
---

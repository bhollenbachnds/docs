...
<Note>
  For **Active Directory Federation Services (AD FS)**, create a **Custom SAML 2.0 identity provider** in PADS4. For detailed configuration instructions, see **Custom SAML 2.0**.
</Note>

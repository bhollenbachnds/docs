---
title: "Okta"
description: "Configure Okta as a SAML 2.0 SSO identity provider for PADS4, set up attribute claims and group mapping, and connect it to the CTRL Centre credential manager."
---

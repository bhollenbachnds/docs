---
title: "Azure Set-up"
description: "Register an Azure Active Directory application and create the client secret that PADS4 CTRL Centre uses to authenticate with Microsoft Power BI service."
---

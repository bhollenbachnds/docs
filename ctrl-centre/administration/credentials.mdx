---
title: "Credentials"
description: "Manage third-party credentials in PADS4 CTRL Centre, connect Microsoft Teams and Power BI providers, and issue user tokens for use in PADS4 Designer."
---
...
You can: ✔ View **all stored credentials**.\
...
**For step-by-step instructions**, refer to the **"[How to add Teams support to PADS4](/ctrl-centre/administration/teams)"** documentation.
...
**For step-by-step instructions**, refer to the **"[How to add PowerBI to PADS4](/ctrl-centre/administration/Power-BI)"** documentation.

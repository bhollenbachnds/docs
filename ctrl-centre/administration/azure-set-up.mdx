---
title: "Azure Set-up"
description: "Register an Azure AD app for the PADS4 Microsoft Teams integration, add the Login hint claim, expose an API scope, and create a client secret for CTRL Centre."
---

...
description: "Register the Power BI Azure app in PADS4 CTRL Centre credential manager and generate token IDs for each report or dashboard you want to embed in a presentation."
---

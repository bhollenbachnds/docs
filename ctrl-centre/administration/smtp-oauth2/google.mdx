---
title: "Google SMTP OAuth2 set-up"
description: "Create a Google Cloud project, enable the Gmail API, and generate OAuth2 client credentials to configure Google SMTP authentication in PADS4 CTRL Centre."
---

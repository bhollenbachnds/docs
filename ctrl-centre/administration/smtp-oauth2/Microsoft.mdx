---
title: "Microsoft SMTP OAuth2 set-up"
description: "Create an Azure app registration with SMTP.Send and offline access permissions to configure Microsoft SMTP OAuth2 authentication in PADS4 CTRL Centre."
---

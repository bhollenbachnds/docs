...
description: "Find the Power BI workspace ID and the report or dashboard ID from the Power BI URL so PADS4 CTRL Centre can embed the correct item in a presentation."
---

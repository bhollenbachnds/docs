...
2. **Identifier** – Enter the \_Microsoft Entra Identifier \_you collected earlier
3. **Reply URL** – Enter the URL of your local PADS4 application (e.g., `https://pads4.mycompany.com`).
4. **Metadata URL** – Enter the Microsoft Entra: \_App Federation Metadata URL \_metadata URL you collected.

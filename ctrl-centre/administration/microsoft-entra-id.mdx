...
description: "Configure Microsoft Entra ID SAML single sign-on for PADS4, create an Azure enterprise application, map group claims, and set up the identity provider."
---

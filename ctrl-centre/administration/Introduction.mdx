...
description: "Overview of the PADS4 Power BI integration through Azure, covering service principal setup, workspace access, capacities, supported scope, and limitations."
---

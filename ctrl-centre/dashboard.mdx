---
title: "Dashboard"
description: "Monitor PADS4 system health from the CTRL Center Dashboard: Viewer status, license expiration alerts, and server synchronization insights."
---
...
<img
  height="200"
  src="/images/ctrl-centre/dashboard.png"
/>
...
_(Visible only if your PADS4 system includes multiple servers—sub/backup servers.)_

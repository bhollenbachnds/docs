---
title: "Viewer Variables and dynamic filtering"
description: "Use Viewer Variables in PADS4 CTRL Center to dynamically filter content per display, like room numbers, so one presentation serves many viewers."
---

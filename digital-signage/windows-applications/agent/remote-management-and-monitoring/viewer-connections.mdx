...
If the reboot or shut down command has been successfully received by the viewer you are informed that the Viewer PC will be shut down in 10 seconds. As a result you will (temporarily) lose the connection.

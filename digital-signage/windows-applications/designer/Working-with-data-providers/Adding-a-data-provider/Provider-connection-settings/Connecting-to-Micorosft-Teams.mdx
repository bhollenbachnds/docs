...
description: "Connect PADS4 to Microsoft Teams as a data provider to retrieve scheduled meetings from an Azure tenant for use in digital signage presentations."
---

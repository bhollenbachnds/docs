...
description: "Connect PADS4 to a Microsoft Exchange Server data provider to retrieve calendar, inbox, contacts, or public folder data for live presentations."
---

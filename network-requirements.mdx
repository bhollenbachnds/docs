---
title: "PADS4 network and firewall requirements"
description: "Reference of TCP, UDP, and HTTP ports used by PADS4 server and client components, including default port 7237 and required inbound or outbound firewall rules."
---
...
If you are using a firewall on the PADS4 Server this means that one or more of the above port numbers will have to be opened in order for PADS4 to communicate over the network. 

On the client side it's not necessary to open any port numbers in the firewall.

...
description: "Replication between PADS4 Main, Sub, and Backup Servers from version 2021.3 onwards, including bidirectional connections and firewall port setup."
hidden: true
---
...
<Note>
  **A full-duplex network connection is required between the Main Server and the Sub/Backup Servers.** Both servers must be able to establish a direct connection with each other for proper replication and synchronization.
</Note>

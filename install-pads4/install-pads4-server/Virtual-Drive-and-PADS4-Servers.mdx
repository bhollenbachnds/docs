...
description: "How PADS4 2021.3 and higher use a Virtual Drive to expose the new Advanced Content Library on Main, Sub, and Backup Servers after an upgrade."
hidden: true
---

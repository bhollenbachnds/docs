...
description: "Turn on MFA in PADS4 from the Multi-Factor Authentication Configuration screen, set the issuer, choose optional or mandatory, and pick an enforcement date."
---

---
title: "Global settings in docs.json"
description: "Configure site-wide options for PADS4 docs in docs.json, including name, theme colors, logo, favicon, navigation, footer, and integrations."
icon: 'gear'
---

---
title: "Configure navigation in docs.json"
description: "Define groups, pages, and nested sections in the navigation field of docs.json to build the sidebar menu of your PADS4 documentation site."
icon: 'map'
---

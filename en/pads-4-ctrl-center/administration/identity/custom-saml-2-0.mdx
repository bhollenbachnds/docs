---
title: "Custom SAML 2.0 identity provider"
description: "Connect PADS4 CTRL Center to any custom SAML 2.0 identity provider to enable single sign-on and centralized authentication for your users."
---
...
You can enable SCIM provisioning during identity provider creation. This feature synchronizes users between the custom SAML 2.0 provider and PADS4, automatically creating, updating, or deleting users linked to the application.

Once enabled, save these values for later use in your Custom SAML 2.0 SCIM configuration:

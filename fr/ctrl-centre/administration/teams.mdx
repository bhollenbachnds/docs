...
4. Configurez les paramètres suivants :
   ...
   * **Supported account types** :\
     ...
     Les comptes Microsoft personnels sont **not** pris en charge.
   * **Redirect URI** :
     ...
     * Entrez l'URI de redirection :
       ...
       * **Host** : Nom DNS ou **IP address** de **PADS4 CTRL Center**.
...
Cette étape permet à **PADS4 Teams integration** de **join Teams meetings** au nom des utilisateurs.
...
4. Entrez un **Application ID URI** :
   ...
   * L'Application ID URI **must start with** `api://` et **cannot contain spaces or special characters**.
...
Le **Client Secret** garantit que PADS4 Teams integration peut **join Teams meetings** sans exiger que les utilisateurs se connectent à chaque fois.
...
1. Ouvrez la ressource**Communication Services resource**.

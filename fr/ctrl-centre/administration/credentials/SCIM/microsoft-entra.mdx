...
Maintenant que le Provisionnement SCIM est activé sur PADS4, vous devrez configurer le provisionnement des utilisateurs SCIM sur le fournisseur d'identité externe
...
* Ajouter le nouvel attribut **externalId** personnalisé

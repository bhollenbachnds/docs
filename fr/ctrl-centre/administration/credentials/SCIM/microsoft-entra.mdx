...
Le provisionnement des utilisateurs est le processus de création, de mise à jour et de suppression automatique des comptes utilisateurs. Il garantit que les utilisateurs obtiennent le bon accès lorsqu'ils rejoignent, changent de rôle ou quittent l'organisation.
...
* **(Facultatif)** Ajouter des attributs facultatifs

Vous pouvez également ajouter des attributs facultatifs qui sont définis par PADS4

Pour les utiliser, vous devrez cliquer à nouveau sur "Add New Mapping" pour chacun de ces attributs et les configurer.

Actuellement, les attributs facultatifs disponibles sont :
...
* Cliquez sur Enregistrer pour sauvegarder la configuration de mappage des utilisateurs
...
Maintenant que la configuration de provisionnement est terminée à la fois sur **Microsoft Entra (Azure)** et **PADS4**, et que les groupes ont été assignés à l'application, le **provisioning service** peut être démarré.

...
* Connectez-vous au portail web PADS4 de votre instance PADS4 avec un compte disposant au moins de la licence PADS4 System Management.
...
* Metadata URL : Représente la "**Metadata URL**" collectée à l'étape 6

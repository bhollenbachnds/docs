...
* Pour l'attribut de groupe, veuillez suivre la configuration ci-dessous et vous assurer que le filtre est défini sur **"Correspond à l'expression régulière"** option.
...
* Cliquez ensuite sur le bouton "Terminer" pour créer l'intégration de l'application
...
## **6. Données de configuration de collection requises pour créer le fournisseur d'identité dans PADS4**
...
* **Identifiant** et **Assertion Consumer Service URL** seront remplis automatiquement.
...
* **Certificat de/pour "domainone"**: Téléchargez le certificat (.PFX) de votre choix pour signer les assertions de PADS4 vers le fournisseur d'identité externe.
* **Mot de passe de la clé privée**: Saisissez le mot de passe associé au certificat PFX utilisé ci-dessus.

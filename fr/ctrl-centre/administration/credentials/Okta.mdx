...
PADS4 permet l'intégration avec **Okta** pour rationaliser **l'authentification et la gestion des utilisateurs**. Cela est accompli via **Credentials** interface dans **PADS4 CTRL Center**.
...
## **5. Assigner des groupes d'utilisateurs à l'application**

Pour définir quels groupes d'utilisateurs auront accès à l'application, vous devrez assigner les groupes d'utilisateurs souhaités à l'application.
...
* Cliquez sur "Assign" pour tous les groupes que vous souhaitez assigner à l'application et cliquez sur "Done"

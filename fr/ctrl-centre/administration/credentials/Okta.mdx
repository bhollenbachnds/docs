...
PADS4 permet l'intégration avec **Okta** pour simplifier **l'authentification et la gestion des utilisateurs**. Cela est réalisé grâce à l'interface **Credentials** dans **PADS4 CTRL Center**.
...
<Warning>
  ...
  Votre nom de domaine configuré peut être vérifié en vous connectant avec votre compte su\root et en allant à la section "Domains" :
...
| Issuer              | [https://www.okta.com/xxxxxxxx](https://www.okta.com/xxxxxxxx)                                                           |

...
PADS4 permet l'intégration avec **Okta** pour simplifier **l'authentification et la gestion des utilisateurs**. Cela s'effectue via l'interface **Credentials** dans **PADS4 CTRL Center**.
...
* Single sign-on URL :
  * URL locale de pads4 avec **/rdx/**[**nds.services**](http://nds.services)**.authentication.integration/api/v1/pads/Saml2/Acs**
...
* Audience URI (SP Entity ID) :
  * URL locale de pads4 avec **/saml** 
  * Par exemple : [https://pads4.mycompany.com/saml](https://pads4.mycompany.com/saml)

<Warning>
  Si le domaine de votre instance pads4 est différent de "pads", vous devez mettre à jour le domaine avec votre propre nom de domaine. (ex : pour un domaine nommé "domaineone", l'URL sera [https://pads4.mycompany.com/rdx/nds.services.authentication.integration/api/v1/domainone/Saml2/Acs](https://pads4.mycompany.com/rdx/nds.services.authentication.integration/api/v1/domainone/Saml2/Acs)
...
* Modifiez les attributs et les revendications pour qu'ils correspondent aux valeurs ci-dessous
...
* Cliquez ensuite sur le bouton "Finish" pour créer l'intégration de l'application

## **5. Attribuer des groupes d'utilisateurs à l'application**

Pour définir quels groupes d'utilisateurs auront accès à l'application, vous devrez attribuer les groupes d'utilisateurs souhaités à l'application.
...
* Cliquez sur "Assign" pour les groupes que vous souhaitez attribuer à l'application et cliquez sur "Done"

![Okta App8](/images/ctrl-centre/administration/credentials/Okta-app8.png)

## **6. Collecte des données de configuration nécessaires à la création du fournisseur d'identité dans PADS4**
...
* Accédez à l'application "Sign On"
* Dans le panneau SAML 2.0, cliquez sur le bouton "More details"
* Collectez les informations suivantes :

| Info. requise           | Exemple                                                                                                                  |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| URL de métadonnées      | [https://myokta.okta.com/app/xxxxxxxxxxxx/sso/saml/metadata](https://myokta.okta.com/app/xxxxxxxxxxxx/sso/saml/metadata) |
...
Avec les informations configurées et récupérées ci-dessus, vous serez en mesure de configurer l'intégration Okta dans PADS4.

* Connectez-vous au portail Web PADS4 de votre instance PADS4 avec un compte disposant au minimum de la licence PADS4 System Management.
* Sur le tableau de bord, ouvrez le menu de gauche et accédez à « Credentials » en bas à gauche.
* Cliquez maintenant sur « Providers » puis sur « New »
...
* Indentifier: Represent the "**Issuer**" collectée à l'étape 6.
* Reply URL : Représente le FQDN PADS4 local
  * Example: [**https://pads4.mycompany.com**](https://pads4.mycompany.com)
* Metadata URL : Représente le "**Metadata URL**" collectée à l'étape 6
...
* **Private key password**: Saisissez le mot de passe associé au certificat PFX utilisé ci-dessus.

<Tip>
  **Si vous n'avez pas besoin d'activer le provisionnement SCIM sur la configuration de votre fournisseur d'identité, vous pouvez terminer le processus de création du fournisseur d'identité en cliquant sur le bouton « Create »**
</Tip>

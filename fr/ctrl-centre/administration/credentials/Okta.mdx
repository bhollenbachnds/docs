...
* **Certificate from/for "domainone"** : Téléchargez le certificat (.PFX) de votre choix pour signer les assertions de PADS4 vers le fournisseur d'identité externe.

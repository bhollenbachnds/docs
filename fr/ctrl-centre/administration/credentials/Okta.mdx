...
* Cliquez sur **Home**.
* Utilisez le **Toggle Sidebar** bouton en **haut à gauche** de l'écran.
...
## **3. Configurer la configuration SAML 2.0**
...
* Single sign-on URL :
  * URL locale pads4 avec **/rdx/**[**nds.services**](http://nds.services)**.authentication.integration/api/v1/pads/Saml2/Acs**
...
* Pour l'attribut de groupe, veuillez suivre la configuration ci-dessous et vous assurer que le filtre est défini sur l'option **"Matches regex"**.
...
* Reply URL : Représente le FQDN local de votre pads4

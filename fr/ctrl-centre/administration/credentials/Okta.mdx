...
PADS4 permet l'intégration avec **Okta** pour simplifier **l'authentification et la gestion des utilisateurs**. Cela est accompli via l'interface **Credentials** dans **PADS4 CTRL Center**.
...
* Connectez-vous au PADS4 Web Portal de votre instance PADS4 avec un compte disposant au minimum de la licence PADS4 System Management.
* Sur le Dashboard, ouvrez le menu de gauche et accédez à "Credentials" en bas à gauche.
...
* **Certificate from/for "domainone"** : Téléchargez tout certificat (.PFX) que vous souhaitez utiliser pour signer les assertions de PADS4 vers le fournisseur d'identité externe.
* **Private key password** : Saisissez le mot de passe associé au certificat PFX utilisé ci-dessus.

<Tip>
  **Si vous n'avez pas besoin d'activer le provisionnement SCIM sur la configuration de votre fournisseur d'identité, vous pouvez terminer le processus de création du fournisseur d'identité en cliquant sur le bouton "Créer"**
</Tip>

...
<Warning>
  Cet article nécessite que vous ayez au moins la version PADS4 2025.2.
</Warning>
...
<Note>
  Assurez-vous que les valeurs "Single sign-on URL" et "Audience URI (SP Entity ID)" ont la structure décrite ci-dessous ou la configuration ne fonctionnera pas.
</Note>
...
* Modifiez les attributs et revendications pour correspondre aux valeurs ci-dessous

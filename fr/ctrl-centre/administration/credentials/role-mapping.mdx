...
Une fois que votre fournisseur d'identité est créé, vous devrez maintenant gérer les mappages de rôles du fournisseur d'identité.
...
* Le nom du groupe SSO est uniquement utilisé ici pour se souvenir de l'identité du groupe que vous avez créé
* L'ID du groupe SSO doit correspondre à la valeur de revendication de groupe que vous avez configurée sur la configuration des revendications du fournisseur d'identité externe
...
* Ce processus doit être répété autant de fois que vous souhaitez spécifier différents groupes d'utilisateurs d'identité externe que vous voulez autoriser pour l'application.

<Warning>
  Si un utilisateur de votre fournisseur d'identité externe est membre d'un groupe qui est inconnu dans le tableau de mappage des rôles ci-dessous, cet utilisateur n'aura par défaut aucun droit sur l'application
</Warning>

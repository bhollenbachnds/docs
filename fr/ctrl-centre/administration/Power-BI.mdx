...
Pour afficher le contenu Power BI dans PADS4, vous avez besoin de **Workspace ID** et **ID du rapport/tableau de bord**.
...
2. **Ouvrir** **Credentials** sous le **menu Administration**.

...
L'absence de définition d'une capacité peut entraîner un **warning above your reports/dashboards** ou les empêcher de s'afficher dans le **PADS4 Viewer**.
...
1. **Connectez-vous à** le **Power BI Admin portal**.
...
3. **Trouvez l'espace de travail** que vous souhaitez utiliser et **ouvrez More Options**.
...
Pour afficher le contenu Power BI dans PADS4, vous avez besoin de l'**Workspace ID** et **ID du rapport/tableau de bord**.

### **Trouver les ID dans l'URL Power BI**

1. **Ouvrir** le **rapport ou tableau de bord Power BI**.
...
* **ID de l'espace de travail** : Se trouve **entre** `groups/` **et** `/reports`.
* **ID du rapport** : Se trouve **entre** `/reports/` **et** `/ReportSection`.
...
* **ID de l'espace de travail** : Se trouve **entre** `groups/` **et** `/dashboards`.
* **ID du tableau de bord** : Se trouve **après** `/dashboards/`.

...
* **Power BI Admin rights are required** pour activer le principal de service dans **Developer settings**.
...
4. **Saisissez les valeurs suivantes** :
   ...
   * **Redirect URI** :\
     Ceci **is not required** pour l'intégration Power BI.
...
Pour afficher le contenu Power BI dans PADS4, vous avez besoin de l'**ID de l'espace de travail** et **ID du rapport/tableau de bord**.
...
* **ID de l'espace de travail**: Trouvé **entre** `groups/` **et** `/reports`.
* **ID du rapport**: Trouvé **entre** `/reports/` **et** `/ReportSection`.
...
* **ID de l'espace de travail**: Trouvé **entre** `groups/` **et** `/dashboards`.
* **ID du tableau de bord**: Trouvé **après** `/dashboards/`.

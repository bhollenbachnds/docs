...
> ⚠️ Si la réclamation de groupe est mal configurée, la connexion sera redirigée avec cette erreur : `No account is defined for your authentication request`
...
2. Cliquez sur **Connect**, puis **New** pour créer des **mappings and groups** pour ce fournisseur.

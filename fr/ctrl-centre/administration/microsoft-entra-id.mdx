...
> 💡 Conseil : Créez un **PADS4 CMS group** dédié dans Windows Server AD et attribuez-le ici.
...
> ⚠️ Si la revendication de groupe est mal configurée, la connexion sera redirigée avec cette erreur :
>

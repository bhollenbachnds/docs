...
4. **Metadata URL** – Entrez le **Microsoft Entra : URL des métadonnées de fédération d'application** URL des métadonnées que vous avez collectée.
...
3. \*\*Mot de passe \*\*- Entrez le mot de passe pour le `.pfx` certificat téléchargé (sous le champ du certificat).

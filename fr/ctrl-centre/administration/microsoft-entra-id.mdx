...
9. Sélectionnez **Users and Groups**. a. Cliquez sur **Add user/group**.

   <img height="200" src="/images/ctrl-centre/sso/9.png" />

   b. Sélectionnez **None Selected**, puis recherchez et sélectionnez des utilisateurs ou des groupes.
...
> 💡 Astuce : Créez un **PADS4 CMS group** dédié dans Windows Server AD et assignez-le ici.
...
2. Assurez-vous que les revendications correspondent à la structure requise pour une connexion réussie.

<img height="200" src="/images/ctrl-centre/sso/17.png" />

3. En particulier, configurez la **group claim** properly:

> ⚠️ Si la revendication de groupe est mal configurée, la connexion sera redirigée avec cette erreur : `No account is defined for your authentication request`
...
* **Reply URL**: Votre environnement PADS (par exemple, `https://pads4serverip`)
* **Metadata URL**:
  * Trouvé sous **SAML Certificates**
  * Copiez l'**App Federation Metadata URL**
* **Certificates**:

  * Téléchargez le certificat **Microsoft Entra certificate** (.cer)
  * Téléchargez le certificat **private key** (.pfx) utilisé pour HTTPS
...
3. Dans [portal.azure.com](https://portal.azure.com) : a. Allez à **Microsoft Entra ID** b. Sélectionnez **Groups** c. Recherchez votre groupe d. Copiez l'**Object ID** (c'est l'ID du groupe)
...
* **Déconnectez-vous et rafraîchissez** le PADS4 Portal

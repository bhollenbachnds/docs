...
3. **Login URL** (ex., `https://login.microsoftonline.com/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/saml2`)
4. **Microsoft Entra Identifier** (ex., `https://sts.windows.net/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/`)
...
3. **Reply URL** – Entrez l'URL de votre application PADS4 locale (ex., `https://pads4.mycompany.com`).

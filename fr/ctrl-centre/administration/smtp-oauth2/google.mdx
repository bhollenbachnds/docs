...
* Cliquez sur **create**
* Une boîte de dialogue apparaîtra avec votre**client ID**  et **client secret**.  Copiez ou téléchargez ces valeurs et stockez-les en toute sécurité, car vous en aurez besoin pour la configuration PADS4
...
* Remplissez les informations comme suit :
  ...
  * **App (client) ID :** Récupéré depuis la Google Cloud Console décrite à l'étape 4
  * **Client Secret :** Récupéré depuis la Google Cloud Console décrite à l'étape 4
* Cliquez sur **create**

...
* Dans votre projet nouvellement créé, allez à **API et services > Bibliothèque**
...
* Naviguez vers **API et services > Écran de consentement OAuth**
...
* Remplissez les informations requises sur l'application
  ...
  * Coordonnées du développeur : Entrez votre adresse email
...
* Allez à **API et services > Clients**

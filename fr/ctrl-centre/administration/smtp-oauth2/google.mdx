...
Ce document fournit des instructions étape par étape pour créer des identifiants OAuth2 pour l'authentification SMTP à l'aide des plateformes Google et Microsoft. Ce document suppose que le lecteur possède une connaissance de base de la Google Cloud Platform.
...
* Cliquez sur **Enable** pour activer l'API Gmail pour votre projet
...
* Sous **Autherized redirect URI's**, cliquez sur \*\*Ajouter une URI \*\*et entrez :
...
* Cliquez sur **create**
* Une boîte de dialogue apparaîtra avec votre**client ID**  et **client secret**.  Copiez ou téléchargez ces valeurs et stockez-les en lieu sûr, car vous en aurez besoin pour la configuration PADS4

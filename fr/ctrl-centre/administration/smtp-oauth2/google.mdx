...
* Remplissez les informations requises de l'application
  ...
  * Email de support utilisateur : Sélectionnez votre adresse e-mail
  * Informations de contact du développeur : Saisissez votre adresse e-mail
...
* Saisissez un nom pour votre client OAuth

![Google Smtp8](/images/ctrl-centre/administration/smtp-oauth2/Google-smtp8.png)

* Sous **Autherized redirect URI's**, cliquez sur \*\*Add URI \*\*et saisissez :
...
* Naviguez vers l'URL du **PADS4 server URL** (soit un nom DNS ou une adresse IP).

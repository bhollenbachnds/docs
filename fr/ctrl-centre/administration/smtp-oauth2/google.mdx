...
* Sous **URI de redirection autorisés**, cliquez sur \*\*Ajouter un URI \*\*et entrez :
  * http\://\<host>:\<port>/credentials/generic/authorize/callback
    ...
    * **Port:** Facultatif, si le portail Web PADS4 n'utilise pas les ports par défaut pour HTTP ou HTTPS, vous devez spécifier le numéro de port.

![Google Smtp9](/images/ctrl-centre/administration/smtp-oauth2/Google-smtp9.png)

* Cliquez sur **créer**
* Une boîte de dialogue apparaîtra avec votre**ID client**  et **secret client**.  Copiez ou téléchargez ces valeurs et stockez-les en lieu sûr, car vous en aurez besoin pour la configuration PADS4

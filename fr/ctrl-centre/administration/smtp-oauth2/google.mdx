...
* Cliquez sur le menu déroulant du projet en haut de la page et sélectionnez '\*\*Select a Project' \*\*puis cliquez sur le **'New Project'.**
...
* Cliquez **Create** pour créer votre projet
...
* Sous **Autherized redirect URI's**, cliquez \*\*Add URI \*\*et entrez:
...
* Cliquez sur **create**
* Une boîte de dialogue apparaîtra avec votre**client ID**  et **client secret**.  Copiez ou téléchargez ces valeurs et conservez-les en sécurité car vous en aurez besoin pour la configuration PADS4
...
* Naviguez vers l'**PADS4 server URL** (soit un nom DNS ou une adresse IP).
...
* Cliquez sur **Home**.
* Utilisez le bouton **Toggle Sidebar** en **top-left** de l'écran.

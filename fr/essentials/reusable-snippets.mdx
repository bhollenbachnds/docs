...
description: "Créez et utilisez des extraits Markdown réutilisables dans votre documentation PADS4 pour maintenir le contenu synchronisé sur plusieurs pages."
icon: "recycle"
---

...
<Warning>
  MDX ne se compile pas à l'intérieur du corps d'une fonction fléchée. Tenez-vous-en à la syntaxe HTML quand vous le pouvez ou utilisez un export par défaut si vous avez besoin d'utiliser MDX.
</Warning>

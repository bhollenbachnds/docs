...
### Comment fonctionne la Sub Priority :
...
Bien que la sub priority ne soit pas directement visible, vous pouvez **manually adjust it** à l'aide de l'interface du Scheduler.

Pour modifier l'importance d'une présentation :

1. Allez à l'onglet **Home** dans la barre de ruban du Scheduler.
2. Dans le groupe **Priority**, utilisez :
   * **Increase Priority** : Augmente la sub priority, lui donnant la préférence sur les autres ayant la même priorité principale.
   * **Decrease Priority** : Diminue la sub priority, réduisant sa chance de remplacer les présentations de priorité similaire.

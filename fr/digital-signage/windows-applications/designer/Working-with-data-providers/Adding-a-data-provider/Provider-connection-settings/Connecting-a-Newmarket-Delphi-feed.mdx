...
### **Étapes pour ajouter ou modifier une connexion au flux Newmarket Delphi**
...
#### **5. Configurer les paramètres de flux Delphi plus anciens (version 9.6 et antérieures)**
...
* Choisissez entre :
  ...
  * **Obtenir les informations de la salle** *(récupère les détails de disponibilité des salles)*.
  * **Inclure les caractéristiques** *(associe automatiquement les détails des salles)*.

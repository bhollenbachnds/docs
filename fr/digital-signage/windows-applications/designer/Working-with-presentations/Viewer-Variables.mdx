...
## **Où Peut-on Utiliser les Viewer Variables ?**
...
| **Contexte**                                                     | **Moment du Remplacement**                                                                                       |
| ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
...
* Les changements dans les Viewer Variables **ne pas déclencher automatiquement** la réévaluation de toutes les règles ou l'actualisation du contenu sauf en cas de rechargement.
* **Fichiers en dehors de la Content Library** référencés avec des Variables Viewer peuvent **ne pas se synchroniser correctement**—conservez les fichiers dans la Content Library.
...
* Facile à mettre à jour et à maintenir—**modifiez la valeur de la variable, pas la présentation**.

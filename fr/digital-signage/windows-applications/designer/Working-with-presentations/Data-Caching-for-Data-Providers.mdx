PADS4 Designer inclut **data caching** une fonctionnalité pour les fournisseurs de données, facilitant et accélérant la conception de présentations pilotées par les données — même lorsque la source de données est lente ou temporairement indisponible.

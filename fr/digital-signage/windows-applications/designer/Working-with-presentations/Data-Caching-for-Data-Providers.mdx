...
* **Permettre le travail de conception hors ligne** lorsque la source de données n'est pas accessible (par exemple, équipes externes ou sites distants).
...
| **Viewer Behavior**            | **Les visionneuses n'utilisent pas les données mises en cache** ; elles nécessitent des connexions en direct |

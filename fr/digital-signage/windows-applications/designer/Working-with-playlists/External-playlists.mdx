...
Pour plus de détails sur **la liaison d'un élément** à une source de données externe, reportez-vous aux **propriétés du fournisseur de données** et **l'utilisation des fournisseurs de données**.
...
| **22**  | Page tourne vers la droite                                            |
| **23**  | Page tourne vers la gauche                                            |
| **24**  | Déplacer vers la gauche                                               |
| **25**  | Déplacer vers la droite                                               |
| **26**  | Déplacer vers le haut                                                 |
| **27**  | Déplacer vers le bas                                                  |
| **28**  | Réservé                                                               |

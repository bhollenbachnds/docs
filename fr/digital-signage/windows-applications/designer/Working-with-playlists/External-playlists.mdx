...
Pour plus de détails sur **la liaison d'un élément** à une source de données externe, reportez-vous aux **propriétés du fournisseur de données** et **travailler avec les fournisseurs de données**.
...
* Les éléments de texte de la playlist peuvent contenir **plusieurs lignes**, séparées par une **\[Entrée]**.

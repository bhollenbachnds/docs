...
Pour plus de détails sur **la liaison d'un élément** à une source de données externe, référez-vous aux **propriétés du fournisseur de données** et **l'utilisation des fournisseurs de données**.
...
* Les éléments de texte de la liste de lecture peuvent contenir **plusieurs lignes**, séparées par une **\[Entrée]**.
...
* Utiliser des **playlists externes** garantit **des mises à jour dynamiques du contenu** sans intervention manuelle.
* **Fournisseurs de données** peuvent être utilisés pour récupérer des éléments de playlist en temps réel.

...
Pour plus de détails sur **la liaison d'un élément** à une source de données externe, consultez **les propriétés du fournisseur de données** et **travailler avec les fournisseurs de données**.
...
* Les éléments texte de la playlist peuvent contenir **plusieurs lignes**, séparées par un **\[Enter]**.
...
* Utilisation **external playlists** assure **dynamic content updates** sans intervention manuelle.

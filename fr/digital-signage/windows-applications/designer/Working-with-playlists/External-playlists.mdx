...
* Les éléments texte d'une playlist peuvent contenir **plusieurs lignes**, séparées par une touche **\[Enter]**.
...
* La **durée par défaut** et les **effets de transition par défaut** paramètres.
...
Si vous devez stocker des **playlists imbriquées** dans un **fichier XML**, le parseur XML peut mal interpréter la structure. Pour éviter cela, **remplacez** `<` et `>` par `&lt;` et `&gt;`.
...
| **3**  | Contenu intégré (ex. : texte)                                                                           |
| **4**  | Contenu hexadécimal (ex. : **commandes RS-232**)                                                        |
| **5**  | URL de flux vidéo                                                                                       |
...
| **24**  | Déplacement par-dessus vers la gauche                                 |
| **25**  | Déplacement par-dessus vers la droite                                 |
| **26**  | Déplacement par-dessus vers le haut                                   |
| **27**  | Déplacement par-dessus vers le bas                                    |
| **28**  | Réservé                                                               |
| **29**  | Flush (**effet HTML5 Viewer**)                                        |
| **30**  | Vortex (**effet HTML5 Viewer**)                                       |
| **31**  | Bounce (**effet HTML5 Viewer**)                                       |
| **999** | Effet par défaut (utilise la **Default Transition Effect** propriété) |

***

### **Notes Finales**

* L'utilisation des **playlists externes** garantit des **mises à jour dynamiques du contenu** sans intervention manuelle.
* **Les fournisseurs de données** peuvent être utilisés pour récupérer des éléments de playlist en temps réel.

...
Avant que des utilisateurs puissent être ajoutés au système, au moins un **profil** doit être créé. Un profil détermine les droits d'accès et les autorisations qu'un utilisateur aura dans le système Crystal Digital Signage.

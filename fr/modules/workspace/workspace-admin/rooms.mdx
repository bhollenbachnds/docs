...
Cette option interroge le calendrier connecté (par exemple, Microsoft Exchange) pour récupérer les informations sur les ressources des salles. Une fois la requête terminée, une liste des salles disponibles s'affiche, vous permettant de sélectionner les salles à ajouter au système.
...
* Définir une capacité réduite (autoriser les réservations qui se chevauchent pour l'espace)
...
* Préciser si les réservations pour cette salle nécessitent une approbation

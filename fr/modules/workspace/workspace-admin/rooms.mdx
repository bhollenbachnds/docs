L'onglet **Rooms** fournit une vue d'ensemble de toutes les salles qui ont été ajoutées au **PADS4 Workspace Module**. À partir de cet onglet, vous pouvez ajouter, supprimer et modifier des salles selon vos besoins.
...
Cette option interroge le calendrier connecté (par ex., Microsoft Exchange) pour récupérer les informations sur les ressources de salle. Une fois la requête terminée, une liste des salles disponibles sera affichée, vous permettant de sélectionner les salles à ajouter au système.

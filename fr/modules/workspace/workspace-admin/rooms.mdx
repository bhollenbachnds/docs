...
* Précisez si les réservations pour cette salle nécessitent une approbation
...
* Configurez si la salle apparaît dans le module complémentaire Outlook ou génère un code QR pour l'accès

...
Activez le plugin sur le **coin supérieur droit**, à côté de **"Type"**, sélectionnez l'**"Azure AD"** option dans la liste déroulante
...
Enregistrez la configuration puis déconnectez-vous et vous devriez maintenant voir le **"Single Sign On"** comme une option :

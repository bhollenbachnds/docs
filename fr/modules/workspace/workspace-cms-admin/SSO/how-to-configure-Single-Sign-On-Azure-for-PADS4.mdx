...
<Warning>
  Si vous \*\*<u>don't</u> \*\* voulez pas utiliser un Application Proxy sur votre application locale, continuez à l'étape 4 ci-dessous et ignorez les étapes 7 et 8.

  Si vous \*\*<u>do</u> \*\* voulez utiliser un Application Proxy pour votre application locale, passez à l'étape 7 et ignorez les étapes 4, 5 et 6.
</Warning>
...
Sélectionnez **"Single sign-on option"**  dans le volet gauche puis **"SAML"**

![10 Pn](/images/10.png)

## Étape 11 : Sélectionnez "Edit" sur "Basic SAMLConfiguration"
...
**Identifier**: URL locale du PADS4 CMS avec /Saml2 **(par exemple :** [https://robin.pads365.com/crystal/domain/Saml2](https://robin.pads365.com/crystal/domain/Saml2))
...
Reply URL : URL locale du PADS4 CMS avec /Saml2/Acs **(par exemple :**[**https://robin.pads365.com/crystal/domain/Saml2/Acs**](https://robin.pads365.com/crystal/domain/Saml2/Acs) )
...
## 3. Obtention de l'"URL SAML SSO"

Dans votre application, sélectionnez **" Single sign-on "** dans le volet gauche

Faites défiler jusqu'à la section **" Set up "your\_application\_name "**&#x20;

Sélectionnez\*\*" Copy "\*\*   option à côté de l'option **" Login URL "**  .

...
<Warning>
  Si vous \*\*<u>ne voulez pas</u> \*\* utiliser un Application Proxy sur votre application sur site, continuez à l'étape 4 ci-dessous et ignorez les étapes 7 et 8.

  Si vous \*\*<u>voulez</u> \*\*utiliser un Application Proxy pour votre application sur site, passez à l'étape 7 et ignorez les étapes 4, 5 et 6.
</Warning>
...
<Info>
  Vous **avez maintenant préparé l'authentification unique (SSO) dans Azure pour votre application PADS4.**
</Info>

# Informations requises pour la configuration SSO dans PADS4 CMS

## Pour configurer l'authentification unique (SSO) dans PADS4 CMS, vous aurez besoin des éléments suivants :
...
## 7. Maintenant que toutes les informations ci-dessus ont été recueillies, PADS4 CMS peut être configuré pour utiliser l'authentification unique (SSO).

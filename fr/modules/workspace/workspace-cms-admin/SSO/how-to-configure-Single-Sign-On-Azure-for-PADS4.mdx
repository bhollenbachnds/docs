...
## \*\*Étape 3 \*\*: Sur le panneau de gauche, sélectionnez **"Enterprise Applications"**
...
Sélectionnez la section **Manage Application Proxy Connectors** ****
...
4. Une fois l'installation terminée, sélectionnez la section **+New Connector** Group
...
\*\*Groupe de connecteurs : \*\*SSO Connector (par défaut). <u>C'est le groupe de connecteurs que vous venez de configurer</u>
...
3. Sélectionnez l'option **"None Selected"** pour accéder aux groupes et utilisateurs :
...
## Étape 11 : Sélectionnez "Edit" sur la "Basic SAMLConfiguration"
...
**\*Remarque :** Si vous avez configuré SSO sur une version antérieure à 2023.1, le nom de domaine n'était pas requis dans l'URL lors de l'utilisation d'un seul domaine. À partir de la version 2023.1, le nom de domaine est requis dans l'URL à la fois pour les configurations à un et plusieurs domaines.
...
### **\*Pour chaque groupe d'utilisateurs ajouté pour utiliser l'application PADS4 CMS, une table de mappage sera nécessaire pour ajouter les groupes à l'interface. Veuillez fournir aux installateurs les ID de groupe et les noms des groupes d'Azure pour garantir que les utilisateurs pourront se connecter.**

...
| **Certificat du serveur de fédération**                      | Téléchargez le **certificat de signature IBM Verify (.cer)**  |
...
* Ajustez le mappage des attributs ou les règles de claims si les utilisateurs ne sont pas correctement assignés.

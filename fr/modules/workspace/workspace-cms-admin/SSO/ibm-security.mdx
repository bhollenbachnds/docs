...
| Champ                                 | Valeur                                                |
| ------------------------------------- | ----------------------------------------------------- |
| **Méthode d'authentification unique** | `SAML 2.0`                                            |
...
Accédez à la section **Relation Table** du plugin SSO et mappez les `groupIDs` entrants d'IBM vers les profils PADS4 :

...
Laisser **Certificat du fournisseur de services** et **Options de chiffrement** vides sauf si le chiffrement est requis par votre organisation.
...
| **Mot de passe de la clé privée**                            | Saisir le mot de passe pour `.pfx`                            |

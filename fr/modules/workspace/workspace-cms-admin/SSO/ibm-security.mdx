...
| **Certificat de signature de la partie de confiance (.pfx)** | Télécharger votre fichier `.pfx` avec clé privée              |
...
Accédez à la **Relation Table** section du plugin SSO et mappez les `groupIDs` d'IBM vers les profils PADS4 :
...
* Ajustez le mappage des attributs ou les règles de claims si les utilisateurs ne sont pas assignés correctement.

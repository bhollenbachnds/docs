...
* Accès à la [IBM Security Verify Console](https://www.ibm.com/security/identity-access-management/verify)
* Certificat de signature (.pem ou .cer) d'IBM Verify
* Certificat PFX avec clé privée pour PADS4 (.pfx)
* URL des métadonnées de fédération (facultatif si importation manuelle)
...
## Étape 2 : Espace de travail PADS4 – Configuration SSO

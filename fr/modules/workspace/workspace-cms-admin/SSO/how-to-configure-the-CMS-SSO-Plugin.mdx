...
<Warning>
  De **PADS4 2025.2 et versions ultérieures**, cette fonctionnalité fait partie de PADS4 CTRL Center. Pour plus d'informations, voir CTRL Center > Administration > Identity.
</Warning>
...
Pour que le SSO fonctionne correctement, PADS4 doit être configuré avec HTTPS. Pour ce faire, vous devrez suivre ce guide en utilisant un certificat SSL.

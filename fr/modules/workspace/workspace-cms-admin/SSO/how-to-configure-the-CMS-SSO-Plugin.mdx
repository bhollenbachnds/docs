Ce manuel ne peut être suivi que si vous avez configuré le SSO dans votre environnement Azure / Entra ID. Vous pouvez suivre cet article pour ce faire : **Single Sign On (Azure)**
...
Pour que le SSO fonctionne correctement, PADS4 doit être configuré avec l'utilisation de HTTPS. Pour ce faire, vous devrez suivre ce guide en utilisant un certificat SSL.
...
Téléchargez ici le Certificate (Raw) de l'application que vous avez téléchargé depuis Azure :

## Étape 4 : Téléchargez le Certificate (Raw) de l'application que vous avez téléchargé depuis Azure
...
Lorsque vous configurez la \*\*"Relation Table"\*\* dans CMS Admin pour le SSO, définissez un profil que vous avez créé pour les utilisateurs ou groupes SSO en relation avec leur niveau de privilège.

...
Pour que le SSO fonctionne correctement, PADS4 doit être configuré avec HTTPS. Pour y parvenir, vous devrez suivre ce guide en utilisant un certificat SSL.

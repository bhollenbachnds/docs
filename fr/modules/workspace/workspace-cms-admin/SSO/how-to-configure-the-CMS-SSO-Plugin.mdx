...
Pour que SSO fonctionne correctement, PADS4 doit être configuré avec l'utilisation de HTTPS. Pour y parvenir, vous devez suivre ce guide avec l'utilisation d'un certificat SSL.
...
## Étape 3 : Insérez les informations obtenues de la section précédente

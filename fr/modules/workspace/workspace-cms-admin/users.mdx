L'onglet **Users** vous permet d'ajouter et de gérer des comptes administrateur au sein du système. Les administrateurs peuvent être ajoutés manuellement ou en les important depuis **Active Directory**, selon la configuration de votre système.

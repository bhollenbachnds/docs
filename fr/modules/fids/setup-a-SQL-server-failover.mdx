...
* Cette machine peut être le serveur SQL ou un autre système qui peut **communiquer avec les deux serveurs PADS4 et tous les visualiseurs PADS4**.
...
* Configurez tous les **visualiseurs PADS4** pour utiliser l'**adresse DNS** du commutateur API au lieu d'une IP de serveur fixe.
...
* Commutateur API DNS
* Visualiseurs et opérateurs PADS4

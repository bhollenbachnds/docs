Cette section fournit des instructions étape par étape pour créer la base de données **PADS4FIDS** à l'aide de **PowerShell**, destinées aux administrateurs système ayant accès à SQL Server.

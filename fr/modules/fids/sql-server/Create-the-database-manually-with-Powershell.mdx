Cette section fournit des instructions étape par étape pour créer la **PADS4FIDS** base de données à l'aide de **PowerShell**, destinée aux administrateurs système ayant accès à SQL Server.

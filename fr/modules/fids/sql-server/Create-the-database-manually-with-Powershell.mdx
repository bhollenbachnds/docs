...
> **Important:** Exécutez ces commandes sur un système avec **SQL Server installed**, en utilisant un compte avec des **system administrator privileges** sur l'instance SQL.

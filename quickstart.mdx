---
title: "Quickstart for PADS4 docs contributors"
description: "Clone the docs repo, preview changes locally with the Mintlify CLI, and publish updates to your PADS4 documentation site in minutes."
---

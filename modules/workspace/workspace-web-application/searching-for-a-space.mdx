...
description: "Find available rooms and workspaces in PADS4 Workspace using list, grid, and interactive floor plan views, with filters for capacity and location."
---

...
# Skip this step (7) if you don't use anApplication Proxy.
...
# Skip this step (8) if you don't use anApplication Proxy.
...
If a unique network port is being utilized, be sure to include this in above string. \*\*E.g \*\*https://robin.pads365.com:444/crystal/domain/Saml2/Acs

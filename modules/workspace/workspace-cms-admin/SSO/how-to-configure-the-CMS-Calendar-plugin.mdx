---
title: "Configure the CMS Calendar plugin with Azure"
description: "Set up the PADS4 CMS Calendar plugin against Microsoft Entra ID and Exchange 365 with OAuth 2.0 so Workspace can read and book rooms."
---

---
title: "Publications"
description: "Review, filter, and edit published PADS4 CMS messages — including title, template, schedule, assigned viewers, and status — from the Publications view."
---

The **Publications** section in PADS4 CMS gives you an overview of all published messages, both active and scheduled. From here, you can manage existing content, edit messages, and export materials if needed.

...
description: "Publish a PADS4 CMS message in three steps — set the title, configure start and end dates with recurrences, and assign viewers or viewer groups."
---
...
- **Recurrence Options** _(if applicable)_:

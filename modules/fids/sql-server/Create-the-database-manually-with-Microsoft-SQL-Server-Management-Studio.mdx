---
title: "Create the FIDS database with SQL Management Studio"
description: "Manually create the PADS4FIDS database in SQL Server Management Studio, add the NT AUTHORITY\\SYSTEM login, and assign the required user permissions."
---

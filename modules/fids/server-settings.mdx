---
title: "FIDS server settings"
description: "Configure PADS4FIDS database settings in PADS4 System Management — SQL Server instance, authentication, and database name for the FIDS product."
---

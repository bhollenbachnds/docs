...
1. **Navigate to the ‘Categories’ section**<br />Use the main navigation menu to select **Categories**.
2. **Click 'Create Category' or the Add (\+) button**<br />This will open a form to define the new category.
...
4. **Save the category**<br />Your new category will now appear in the list and be available when creating messages or assigning masks.

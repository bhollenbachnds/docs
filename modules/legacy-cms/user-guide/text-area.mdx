...
1. **Go to the ‘Text Area’ section**<br />Select **Text Area** from the main navigation menu.
2. **View existing text blocks**<br />You’ll see a list of all stored text snippets, each associated with a title or identifier.

### Creating or Editing Text Blocks

1. **Click 'Add' or 'New Text'**<br />This opens the editor interface.
2. **Enter a name or title**<br />Give your text block a unique and descriptive name so it’s easy to identify.
...
4. **Save the text area**<br />Once saved, the text area becomes available for use in messages.

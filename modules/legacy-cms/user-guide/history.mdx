...
1. **Navigate to the ‘History’ section**<br />Select **History** from the navigation menu.
2. **View the broadcast log**<br />The interface displays a chronological list of previously published messages. Each entry includes:
   - **Message title**
   - **Start and end time**
   - **Targeted viewers**
